                            ...
                            <div class="movie-content">
                                <img src="<?='dashboard/'.$m['movie_poster'];?>">
                                    <p><?= $m['movie_description']; ?></p>  
                                     <button class="btn-primary btn-ticket">BUY TICKET</button>  
                            </div>
                        </div>
                        <?php endwhile;?>
                        <!-- <div class="col-md-3">
                            <div class="movie-content">
                                ...
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia, cum, alias sunt laboriosam itaque blanditiis mollitia
                                    commodi reprehenderit corrupti voluptatem rem animi totam dignissimos dicta voluptate ullam illo quidem! Similique!</p>
                                <button class="btn-primary btn-ticket">BUY TICKET</button>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="movie-content">
                                <img src="img/blackpanther.jpg">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia, cum, alias sunt laboriosam itaque blanditiis mollitia
                                    commodi reprehenderit corrupti voluptatem rem animi totam dignissimos dicta voluptate ullam illo quidem! Similique!</p>
                                <button class="btn-primary btn-ticket">BUY TICKET</button>
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <div class="row contact-info">
                        ...
                        <div class="col-md-4">
                            <div class="contact-address">
                                ...
                                <h3>Address</h3>
                                <address>
                                    Osho Complex, Sasio Rd, off Lunga lunga, Industrial Area P.O. Box 49916 – GPO 00100 Nairobi – Kenya
                                </address>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="contact-email">
                                ...
                                <h3>Email</h3>
                                <p>
                                    <a href="mailto:info@oshochemicals.com">info@oshochemicals.com</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="form">
                        ...
                        <form action="form.php" method="GET" role="form" class="contactForm">
                            <div class="form-row">
